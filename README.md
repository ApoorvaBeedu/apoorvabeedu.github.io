...
The website design is just a modification of [Leonid Keselman's website](https://github.com/leonidk/leonidk.github.io) and is converted for my own use, re-purposing my old markdown posts. **Feel free to use template for your own purposes**, but please respect copyright for all the images/content in my `images`, `pdfs`, `_posts` folders. 
